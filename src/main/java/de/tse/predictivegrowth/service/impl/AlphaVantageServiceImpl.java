...
import de.tse.predictivegrowth.entity.extern.AlphaVantageStockDayData;
...
public class AlphaVantageServiceImpl extends AbstractRestService<AlphaVantageDao> implements ExtDataProviderService {
    ...
    private StockDayData getStockDayData(Map.Entry<LocalDate, AlphaVantageStockDayData> entrySet) {
